...
전체 분량: 30-35줄 내외로 작성해주세요.`
  ...
  event_announcement: {
    ...
    template: `당신은 경험 많은 교사로서 학교 행사를 안내하는 따뜻하고 전문적인 통신문을 작성해주세요.
...
다음 구조로 편지 스타일과 구조화된 정보를 자연스럽게 융합하여 작성해주세요:

1. **따뜻한 인사말**
안녕하십니까? 계절의 변화와 함께 아이들의 성장을 지켜보며 학부모님께 감사 인사를 드립니다. {eventName} 행사를 안내드리고자 이렇게 통신문을 보내드립니다.

2. **🎉 행사 소개 및 의미**
- **행사명:** {eventName}
- **교육적 목적:** {eventPurpose}를 통해 아이들에게 주고자 하는 의미
- **기대 효과:** 이 행사를 통해 아이들이 얻게 될 소중한 경험과 성장
- **특별한 의미:** 우리 학급/학교만의 특별한 가치와 추억 만들기

3. **📅 행사 세부 안내**
- **일시:** {eventDate} {eventTime} (구체적인 시간 안내)
- **장소:** {eventLocation} (찾아오시는 방법이나 주차 안내 포함)
- **참여 대상:** {eventTarget}
- **주요 프로그램:** {eventProgram}의 흥미진진한 내용들
- **예상 소요시간:** 대략적인 행사 진행 시간

4. **🎒 준비사항 및 당부**
- **개인 준비물:** 꼭 필요한 물품들 (구체적으로 명시)
- **복장 안내:** 행사에 적합한 복장 및 주의사항
- **안전 수칙:** 안전하고 즐거운 행사를 위한 약속들
- **참여 방법:** 당일 진행 절차와 집합 장소

5. **📞 소통 창구**
- **문의처:** {contactInfo}
- **협조 요청:** 성공적인 행사를 위해 학부모님께 부탁드리는 사항들
- **변경사항 안내:** 날씨나 상황 변화 시 연락 방법

6. **기대와 감사의 마무리**
아이들에게 소중한 추억이 될 이번 행사가 성공적으로 진행될 수 있도록 학부모님들의 많은 관심과 협조를 부탁드립니다. 함께 만들어갈 특별한 하루를 기대하며, 가정의 건강과 행복을 기원합니다.

**작성 원칙:**
- 행사에 대한 기대감과 설렘이 느껴지도록 작성
- 구체적이고 실용적인 정보 제공
- 학부모의 입장에서 궁금할 만한 사항들을 미리 안내
- 교사로서의 열정과 아이들에 대한 사랑이 드러나도록
- 격식을 갖추면서도 친근하고 따뜻한 어조 유지

전체 분량: 20-25줄 내외로 작성해주세요.`
  },
